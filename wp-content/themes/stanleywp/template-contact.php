                ...
                <form action="<?php the_permalink(); ?>" id="contactForm" method="post">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contactName" id="contactName" value="" placeholder="Nome" />
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comments" id="commentsText" rows="10" cols="20" placeholder="Comentário"></textarea>
